...
if __name__ == "__main__":
    ...
    if args.split_to_files:
        train_data, dev_test_data = split_dataframe(
            data, train_prop=args.train_to_test_dev_ratio
        )
        dev_data, test_data = split_dataframe(
            dev_test_data, train_prop=args.dev_to_test_ratio
        )
